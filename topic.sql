...
INSERT INTO students (user_id, student_code, status, gender, department_id, birthday)
    VALUES (@user_id, CONCAT(@user_id, YEAR(CURDATE)), 0, 0, 1, DATE_SUB(CURDATE(), INTERVAL 50 YEAR));
