        ...
        <div class="modal-content">
            {!! Form::open([
                ...
                <div class="modal-body">
                    {!! Form::label('score', __('message.Score')) !!}
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <button type="button" onclick="event.preventDefault();updateResultStudent(`{{ route('students.update-student-result', $student->id)}}`,{{ $subject->id }})" class="btn btn-primary">{{ __('message.Update')}}</button>
                </div>
            {!! Form::close() !!}
        </div>
    </div>
